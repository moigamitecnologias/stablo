      ...
      <div className="grid my-10 md:grid-cols-2">
        <div className="my-10">
          ...
          <p className="max-w-sm mt-5">
            Tem algo a dizer? Estamos aqui para ajudar. Preencha o formulário, envie um e-mail ou ligue para nós.
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="my-10">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                {...register("email", {
                  required: "Insira seu email, por gentileza!",
                  pattern: {
                    value: /^\S+@\S+$/i,
            ...
            <div className="mb-3">
              <textarea
                ...
                {...register("message", {
                  required: "Diga como podemos ajudar."
                })}
              />
              {errors.message && (
                <div className="mt-1 text-red-600">
